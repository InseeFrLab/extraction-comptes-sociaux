...
export MLFLOW_TRACKING_URI="https://projet-extraction-tableaux-mlflow.user.lab.sspcloud.fr"
export MLFLOW_EXPERIMENT_NAME="extraction"

mlflow run ~/work/extraction-comptes-sociaux/ --entry-point extraction --env-manager=local -P remote_server_uri=$MLFLOW_TRACKING_URI -P config_path=config/tablenet_config/tablenet_config_cycle.yaml
